...
- `SPEC.md` explains product requirements and long-lived constraints.
- `ARCHITECTURE.md` gives the quick source tree map.
...
5. The source files referenced by that doc
