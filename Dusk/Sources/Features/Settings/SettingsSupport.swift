...
enum SettingsSupport {
    ...
    static let playbackAdvancedFooterText = "AI Upscaling sharpens lower-resolution video when the source benefits from it, but can increase power usage. Force AVPlayer and Force VLCKit bypass automatic engine selection. Enabling one disables the other. Force AVPlayer may fail on formats it cannot handle."
